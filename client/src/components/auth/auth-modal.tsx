        ...
        <div className="luxury-gradient p-6 text-primary-foreground">
          ...
          <p className="text-center text-primary-foreground/70 mt-2 text-sm">
            {mode === 'login' ? 
              ...
              'Join us today and start managing your bookings with ease!'
            }
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative mt-1.5">
                ...
                <button
                  ...
                  className="absulote right-3 top-1/2 -translate-y-1/2 text-muted-foreground hover:text-foreground"
                >
